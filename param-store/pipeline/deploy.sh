CF_STACK_NAME=pge-crm-param-store-codepipeline-stack
CF_TEMPLATE_FILE_PATH=./SSM-param-pipeline-cft.yml
CF_PARAMETERS_FILE_PATH=./SSM-param-pipeline-cft-values.json
