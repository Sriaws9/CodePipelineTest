CF_STACK_NAME=dctm-d2dev-content-server-pipeline-stack
CF_TEMPLATE_FILE_PATH=./cont-server-pipeline-cft.yml
CF_PARAMETERS_FILE_PATH=./cont-server-pipeline-cft-values.json
