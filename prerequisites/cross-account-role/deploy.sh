CF_STACK_NAME=pge-crm-cross-account-stack
CF_TEMPLATE_FILE_PATH=./cross-account-role.yml
CF_PARAMETERS_FILE_PATH=./cross-account-role-values.json
CF_TAGS_FILE_PATH=../../tags.json
AWS_PROFILE_NAME=ECM_Admin
